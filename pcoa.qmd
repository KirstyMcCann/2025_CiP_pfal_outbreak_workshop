...
```{r genlight-conversion, echo=TRUE, message=FALSE, warning=FALSE, paged.print=FALSE}
...
```{r pcoa, echo=TRUE, message=FALSE, warning=FALSE, paged.print=FALSE}
...
### **Why It’s Useful for This Workshop**
