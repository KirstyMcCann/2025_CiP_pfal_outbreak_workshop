...
dist_mat_all <- readRDS("derived/dist_mat_all.rds")

gl_all <- readRDS("derived/gl_all.rds")
```
...
```{r map-connectedness-func, echo=TRUE, message=FALSE, warning=FALSE, paged.print=FALSE}
...
```{r connectedness-site, echo=TRUE, message=FALSE, warning=FALSE, paged.print=FALSE}
...
```{r, dpac_site, echo=TRUE, message=FALSE, warning=FALSE, paged.print=FALSE}
...
-   DAPC = Discriminant Analysis of Principal Components, implemented in [adegenet](https://academic.oup.com/bioinformatics/article/24/11/1403/191127).
